  ...
  public static class Destination extends NavDestination {
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs) {
      ...
      TypedArray a = context.getResources().obtainAttributes(attrs,
          com.bluelinelabs.conductor.archnavigation.R.styleable.ControllerNavigator);
      setControllerClass(getControllerClassByName(context, a.getString(
          com.bluelinelabs.conductor.archnavigation.R.styleable.ControllerNavigator_android_name)));
      a.recycle();
    }
